...
| Satellites | [CelesTrak](https://celestrak.org) GP elements, SGP4 via satellite.js | 2 h | Fully time-scrubbable. Default groups: stations, brightest, GPS, military, weather. ~11k "all active" is opt-in. |

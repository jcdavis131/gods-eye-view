          ...
          <div className="space-y-4 px-5 py-4 text-[11px] leading-relaxed">
            <section>
              ...
              <ul className="list-disc space-y-1 pl-4 text-foreground/90">
                ...
                <li>No face recognition, no person tracking, no search for named individuals, no licence plates, no phone signals. No code path identifies a person from a face, a track, a licence plate or a phone signal, and no search goes from a person&apos;s name to what they own.</li>
                <li>Parcels, addresses and ownership appear as each public source publishes them, with nothing added. ⌘K search looks only at names and published identifiers (callsign, registration, MMSI, NORAD id, fire id, ticker, place names), never at owner, operator, manager or easement-holder fields, so an owner&apos;s name finds land only where the publisher&apos;s own name for it contains that name. Companies and banks are found by the names their regulators publish, and a bank branch&apos;s name includes its bank, so a bank&apos;s name lists its loaded branches.</li>

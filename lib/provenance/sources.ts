...
export const SOURCES = {
  ...
  "nifc-wfigs": { id: "nifc-wfigs", name: "WFIGS Current Interagency Fire Perimeters and Wildland Fire Incident Locations", publisher: "National Interagency Fire Center", url: "https://data-nifc.opendata.arcgis.com/", license: "public; NIFC: not legal documents, no warranty" },
  "nasa-firms": { id: "nasa-firms", name: "FIRMS active fire data (VIIRS, MODIS NRT)", publisher: "NASA LANCE FIRMS, part of NASA ESDIS", url: "https://firms.modaps.eosdis.nasa.gov/", license: "NASA open data; acknowledgement requested" },
  gdacs: { id: "gdacs", name: "Global Disaster Alert and Coordination System", publisher: "European Commission Joint Research Centre", url: "https://www.gdacs.org/", license: "CC BY 4.0 (European Union), credit to GDACS" },
  "nasa-eonet": { id: "nasa-eonet", name: "Earth Observatory Natural Event Tracker (EONET) v3", publisher: "NASA", url: "https://eonet.gsfc.nasa.gov/", license: "NASA open data" },
  "usfws-nwi": { id: "usfws-nwi", name: "National Wetlands Inventory", publisher: "U.S. Fish and Wildlife Service", url: "https://www.fws.gov/program/national-wetlands-inventory", license: "public domain" },
  "usgs-padus": { id: "usgs-padus", name: "Protected Areas Database of the United States (PAD-US) 4.1", publisher: "U.S. Geological Survey Gap Analysis Project", url: "https://doi.org/10.5066/P96WBCHS", license: "public domain" },
  "gfz-kp": { id: "gfz-kp", name: "Geomagnetic Kp index", publisher: "GFZ Potsdam", url: "https://kp.gfz.de/", license: "CC BY 4.0" },
  "nasa-donki": { id: "nasa-donki", name: "Space Weather Database Of Notifications, Knowledge, Information (DONKI)", publisher: "NASA Community Coordinated Modeling Center", url: "https://kauai.ccmc.gsfc.nasa.gov/DONKI/", license: "NASA open data; experimental research information" },
  "youtube-oembed": { id: "youtube-oembed", name: "YouTube oEmbed (NASA's ISS live stream)", publisher: "YouTube", url: "https://www.youtube.com/@NASA", license: "YouTube Terms of Service; embedded player only" },
